...
<c:forEach var="item" items="${ClientRepo.findAll()}">
    <c:if test="${ClientID == item.getClient_ID()}">
        ...
        <table>
            ...
            <tr class="filterBG">
                <form method = "put" action="/ClientEdited">

                    <td><input type="text" name="first" value="${item.getClient_First_Name()}"></td>
                    <td><input type="text" name="last" value="${item.getClient_Last_Name()}"></td>

                        <!-- Status Dropdown Start -->
                    <td>
                        <select name="status">
                            <option value="${item.getClient_Status_ID()}">
                                    ${Client_StatusRepo.findById(item.getClient_Status_ID()).get().getClient_Status()}
                            </option>
                            <c:forEach var="itemb" items="${Client_StatusRepo.findAll()}">
                                <option value="${itemb.getClient_Status_ID()}">
                                        ${itemb.getClient_Status()}
                                </option>
                            </c:forEach>
                        </select>
                    </td>
                    ...
                    <td><input type="text" name="type" value="${item.getClient_Type()}">


                    <td><input type="hidden" name="id" value="${item.getClient_ID()}">
