...
<c:forEach var="item" items="${RoomRepo.findAll()}">
    <c:if test="${RoomID == item.getRoom_ID()}">

        <h2>Edit Room at Property</h2>
        <table>
            ...
            <tr class="filterBG">
                <form method = "put" action="/RoomEdited">
                    <td>
                    ...
                    <td><input type="text" name="Room_Type" value="${item.getRoom_Type()}"></td>

                    <td><input type="text" name="Room_Area_ft" value="${item.getRoom_Area_ft()}"></td>


                    <td><input type="hidden" name="id" value="${item.getRoom_ID()}">
