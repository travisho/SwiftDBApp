...
<head>
    <title>Edit Paycheck</title> <!-- CHANGE THIS TO THE TEXT THAT SHOULD APPEAR IN THE TAB BAR -->
    <meta charset="utf-8">
...
<c:forEach var="item" items="${paycheckRepo.findAll()}">
    <c:if test="${Paycheck_ID == item.getPaycheck_ID()}">
        ...
        <table>
            <tr>
                ...
                <th>Month of Services</th>
                <th colspan="2">Actions</th>

            </tr>

            <tr class="filterBG">
                <form method="put" action="/PaycheckEdited">
                ...
                <td><input type="text" name="Paycheck_Amount" value="${item.getPaycheck_Amount()}"></td>
                <td><input type="text" name="Date_Of_Payment" value="${item.getDate_Of_Payment()}"></td>
                <td><input type="text" name="Month_Of_Services" value="${item.getMonth_Of_Services()}"></td>
                <td><input type="hidden" name="id" value="${item.getPaycheck_ID()}">
