...
<table>
    ...
    <tr class="filterBG">
        <form action="/PropertyRemodelFilter">
            <td>
                <select name="street">
                    <option value=""/>
            ...
            <td><input type="text" name="Date of Remodel" value="${item.getDate_of_Remodel()}"></td>
            <td><button class="btn"><i class="fa fa-search" style="color:white;"></i></button></td>
        </form>
        <td>
            <form action="/PropertyRemodelRedirect">
                <button>New Property Remodel</button>
            </form>
        </td>
    </tr>

    <c:forEach var="item" items="${PropertyRemodelList}">
        <tr id="tableData">
            <td>${PropertyRepo.findById(item.getProperty_ID()).get().getStreet_Address()}</td>

            <td>${item.getDate_of_Remodel()}</td>
            <td>
                <form action="/PropertyRemodelEdit/${item.getRemodel_ID()}">
            ...
            <td>
                <form action="/PropertyRemodelDelete/${item.getRemodel_ID()}">
                    <button type="submit" value="Edit">
