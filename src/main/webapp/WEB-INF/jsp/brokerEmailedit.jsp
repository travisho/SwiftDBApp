...
<head>
    <title>Editing Broker Email</title>
    <meta charset="utf-8">
...
<c:forEach var="item" items="${broker_EmailRepo.findAll()}">
    <c:if test="${Broker_Email_ID == item.getBroker_Email_ID()}">
        ...
        <table>
            ...
            <tr class="filterBG">
                <form method = "put" action="/BrokerEmailEdited">
                    <td>
                        <select name="broker">
                    ...
                    <td><input type="text" name="email" value="${item.getBroker_Email()}"></td>
                    <td><input type="hidden" name="id" value="${item.getBroker_Email_ID()}"><input type="submit" value="Submit"></td>
                </form>
            </tr>
