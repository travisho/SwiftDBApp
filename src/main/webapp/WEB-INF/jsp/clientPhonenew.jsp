...
<head>
    <title>New Client Phone Number</title>
    <meta charset="utf-8">
...
<table>
    ...
    <tr class="filterBG">
        <form method="put" action="/ClientPhoneNew">
                ...
                <select name="first">
                    ...
                    <c:forEach var="itema" items="${ClientRepo.findAll()}">
                        <option value="${itema.getClient_ID()}">
                                <%--               ${ClientRepo.findById(itema.getClient_ID()).get().getgetClient_First_Name()}  --%>
                                ${itema.getClient_First_Name()} ${itema.getClient_Last_Name()}
