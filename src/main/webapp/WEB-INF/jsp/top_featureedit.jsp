...
<c:forEach var="item" items="${Top_FeatureRepo.findAll()}">
    <c:if test="${Top_FeatureID == item.getTop_Feature_ID()}">

        <h2>Edit Top Property Feature</h2>
        ...
        <table>
            ...
            <tr class="filterBG">
                <form method = "put" action="/TopFeatureEdited">

                    <td><input type="text" name="top_feature" value="${item.getTop_Feature()}"></td>
                    <td><input type="hidden" name="id" value="${item.getTop_Feature_ID()}"><input type="submit" value="Submit"></td>
                </form>
            </tr>
