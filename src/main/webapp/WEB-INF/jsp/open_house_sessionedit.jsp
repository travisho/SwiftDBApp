...
<head>
    <title>Edit Open House Session</title>
    <meta charset="utf-8">
...
<div class="content">
    ...
    <body>
        ...
        <c:forEach var="item" items="${Open_House_SessionRepo.findAll()}">
            <c:if test="${Open_House_ID == item.getOpen_House_ID()}">

                <h2>Edit Open House Session For Property At ${propertyRepo.findById(item.getProperty_ID()).get().getStreet_Address()}</h2>
                ...
                <table>
                    ...
                    <tr class="filterBG">
                        <form method = "put" action="/Open_House_SessionEdited">
                            <td><input type="text" name="ohdate" value="${item.getDate_Of_Open_House()}"></td>

                            <!-- Property Address Dropdown Start -->
                            <td>
                                <select name="street">
                            ...
                            <!-- Property Address Dropdown End -->

                            <td><input type="hidden" name="id" value="${item.getOpen_House_ID()}"><input type="submit" value="Submit"></td>
                        </form>
                    </tr>
                </table>
                <!-- Table ends here -->
