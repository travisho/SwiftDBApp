...
<table>
    ...
    <tr class="filterBG">
        <form action="/TitleOwnerFilter">
            <td></td>
            <td></td>
            <td></td>
            <td><input type="text" name="title_owner"></td>
            <td><button class="btn"><i class="fa fa-search" style="color:white;"></i></button></td>
        </form>

        <td>
            <form action="/TitleOwnerRedirect">
                <button>New Title Owner</button>
            </form>
        </td>
    </tr>
    <c:forEach var="item" items="${titleownerList}">
        <tr id="tableData">
            ...
            <td>${item.getTitle_Owner()}</td>
            <td>
                <form action="/TitleOwnerEdit/${item.getTitle_Owner_ID()}">
            ...
            <td>
                <form action="/TitleOwnerDelete/${item.getTitle_Owner_ID()}">
