...
<head>
    <title>New Property Remodel</title>
    <meta charset="utf-8">
...
<table>
    ...
    <tr class="filterBG">
        <form method="put" action="/PropertyRemodelNew">
            ...
            <td><input type="date" name="Date_Of_Remodel" value="${item.getDate_of_Remodel()}">
