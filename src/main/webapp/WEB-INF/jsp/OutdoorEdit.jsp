...
<c:forEach var="item" items="${OutdoorRepo.findAll()}">
    <c:if test="${OutdoorID == item.getOutdoor_ID()}">
        ...
        <table>
            ...
            <tr>
                ...
                <th>Patio Size Area</th>
                <th>Sprinkler System</th>
                <th colspan="2">Actions</th>
            </tr>

            <tr class="filterBG">
                <form method = "put" action="/OutdoorEdited">
                    <td>
                    ...
                    <td><input type="text" name="Patio Size Area" value="${item.getPatio_Size_Area()}"></td>
                    <td><input type="text" name="Sprinkler System" value="${item.getSprinkler_System()}"></td>
                    <td><input type="hidden" name="id" value="${item.getOutdoor_ID()}"></td>
