...
<table>
    ...
    <tr class="filterBG">
        <form action="/PaycheckFilter">
            <td><input type="text" name="agent" value=""></td>
            <td><input type="text" name="Paycheck_Amount" value=""></td>
            <td><input type="text" name="Date_Of_Payment" value=""></td>
            <td><input type="text" name="Month_Of_Services" value=""></td>
            <td><button class="btn"><i class="fa fa-search" style="color:white;"></i></button></td>
        </form>

        <td>
            <form action="/PaycheckRedirect">
                <button>New Paycheck</button>
            </form>
        </td>
    </tr>
    </tr>

    <c:forEach var="item" items="${PaycheckList}">
        <tr id="tableData">
            ...
            <td>${item.getPaycheck_Amount()}</td>
            <td>${item.getDate_Of_Payment()}</td>
            <td>${item.getMonth_Of_Services()}</td>
            <td>
                <form action="/PaycheckEdit/${item.getPaycheck_ID()}">
            ...
            <td>
                <form action="/PaycheckDelete/${item.getPaycheck_ID()}">
