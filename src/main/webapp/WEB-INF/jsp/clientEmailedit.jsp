...
<c:forEach var="item" items="${client_EmailRepo.findAll()}">
    <c:if test="${Client_Email_ID == item.getClient_Email_ID()}">


<h2>Client Email Edit</h2>
        <table>
            ...
            <tr class="filterBG">
                <form method = "put" action="/ClientEmailEdited">
                    <td>
                        <select name="client">
                    ...
                    <td><input type="text" name="email" value="${item.getClient_Email()}"></td>
                    <td><input type="hidden" name="id" value="${item.getClient_Email_ID()}"><input type="submit" value="Edit"></td>
                </form>
            </tr>
