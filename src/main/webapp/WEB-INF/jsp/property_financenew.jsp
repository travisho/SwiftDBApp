...
<head>
    <title>Creating Property Finance</title> <!-- CHANGE THIS TO THE TEXT THAT SHOULD APPEAR IN THE TAB BAR -->
    <meta charset="utf-8">
...
<div class="content">
    ...
    <body>
 <h2>New Property Finance</h2> <!-- THIS SHOULD BE TITLE OF YOUR PAGE-->
...
<table>
    ...
    <tr class="filterBG">
        <form method="put" action="/Property_FinanceNew">
