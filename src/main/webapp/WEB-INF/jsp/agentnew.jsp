...
<head>
    <title>Creating Agent</title> <!-- CHANGE THIS TO THE TEXT THAT SHOULD APPEAR IN THE TAB BAR -->
    <meta charset="utf-8">
...
<div class="content">
 ...
 <h2>New Agent</h2> <!-- THIS SHOULD BE TITLE OF YOUR PAGE-->
<table>
    ...
    <tr class="filterBG">
        <form method="put" action="/AgentNew">
