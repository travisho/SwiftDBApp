...
<h2>Heating Unit List</h2>

<!-- Table starts here -->
<table>
    <tr>
        <th>Floor Plan</th>
        <th>Heating_Unit_Type</th>
        <th>Heating_Unit_Age_Years</th>
        <th colspan="2">Actions</th>
    </tr>

    <tr class="filterBG">
        <form action="/Heating_UnitFilter">
            <td><input type="text" name="Floor_Plan" value=""></td>
            <td><input type="text" name="Heating_Unit_Type" value=""></td>
            <td><input type="text" name="Heating_Unit_Age_Years" value=""></td>
            <td><input type="submit" value="Search"></td>
        </form>
        <td>
            <form action="/Heating_UnitRedirect">
                <button>New Heating_Unit</button>
            </form>
        </td>
    </tr>

    <c:forEach var="item" items="${Heating_UnitList}">
        <tr id="tableData">
            ...
            <td>${item.getHeating_Unit_Type()}</td>
            <td>${item.getHeating_Unit_Age_Years()}</td>
            <td>
                <form action="/Heating_UnitEdit/${item.getHeating_Unit_ID()}">
                    <button type="submit" value="Edit">
                        <i class="fas fa-edit"></i></button>
                </form>
            </td>
            <td>
                <form action="/Heating_UnitDelete/${item.getHeating_Unit_ID()}">
