...
<c:forEach var="item" items="${Heating_UnitList}">
    <c:if test="${Heating_Unit_ID == item.getHeating_Unit_ID()}">

        <h2>Heating Unit ${item.getHeating_Unit_Type()} ${item.getHeating_Unit_Age_Years()}</h2>
        ...
        <table>
            ...
            <tr class="filterBG">
                <form method = "put" action="/Heating_UnitEdited">
                    <td>
                    ...
                    <td><input type="text" name="Heating_Unit_Type" value="${item.getHeating_Unit_Type()}"></td>
                    <td><input type="text" name="Heating_Unit_Age_Years" value="${item.getHeating_Unit_Age_Years()}"></td>
                    <td><input type="hidden" name="id" value="${item.getHeating_Unit_ID()}">
