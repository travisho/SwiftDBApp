...
<table>
 ...
 <form action="/Utility_BillFilter">
            <td><input type="text" name="Street">
            <td><input type="text" name="Utility">
            <td><input type="text" name="Cost_Of_Utility">
        ...
        <td>
            <form action="/Utility_BillRedirect">
                <button>New Utility Bill</button>
            </form>
        </td>

    </tr>

    <c:forEach var="item" items="${Utility_BillList}">
        <tr id="tableData">
<%--        <td>${Utility_BillRepo.findById(item.getUtility_Bill_ID()).get().getUtility()}</td>--%>
            <td>${PropertyRepo.findById(Property_FinanceRepo.findById(item.getProperty_Finance_ID()).get().getProperty_ID()).get().getStreet_Address()}</td>
            <td>${item.getUtility()}</td>
            <td>${item.getCost_Of_Utility()}</td>
            <td>
                <form action="/Utility_BillEdit/${item.getUtility_Bill_ID()}">
            ...
            <td>
                <form action="/Utility_BillDelete/${item.getUtility_Bill_ID()}">
