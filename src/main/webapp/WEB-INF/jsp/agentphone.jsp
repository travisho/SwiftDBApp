...
<head>
    <title>Agent Phone Number</title>
    <meta charset="utf-8">
    ...
    <body>
        ...
        <table>
            ...
            <tr class="filterBG">
                ...
                <td>
                    <form action="/AgentPhoneRedirect">
                        <button>New</button>
                    </form>
                </td>
            </tr>

            <c:forEach var="item" items="${agentphoneList}">
                <tr id="tableData">
                    ...
                    <td>${item.getAgent_Phone_Number()}</td>
                    <td>${item.getAgent_Phone_Type()}</td>
                    <td>
                        <form action="/AgentPhoneEdit/${item.getAgent_Phone_Number_ID()}">
                    ...
                    <td>
                        <form action="/AgentPhoneDelete/${item.getAgent_Phone_Number_ID()}">
