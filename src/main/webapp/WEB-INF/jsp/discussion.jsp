...
<table>
            ...
            <tr class="filterBG">
                ...
                <td>
                <form action="/DiscussionRedirect">
                    <button>New</button>
                </form>
                </td>
            ...
            <c:forEach var="item" items="${discussionList}">
                <tr id="tableData">
                    <td>${agentRepo.findById(item.getAgent_ID()).get().getAgent_First_Name()} ${agentRepo.findById(item.getAgent_ID()).get().getAgent_Last_Name()}</td>
                    <td>${clientRepo.findById(item.getClient_ID()).get().getClient_First_Name()} ${clientRepo.findById(item.getClient_ID()).get().getClient_Last_Name()}</td>
                    <td>${discussion_mediumRepo.findById(item.getDiscussion_Medium_ID()).get().getDiscussion_Medium()}</td>
                    <td>${item.getDiscussion_Time()}</td>
                    <td>${item.getDiscussion_Topic()}</td>
                    <td>${item.getDiscussion_Summary()}</td>
                    <td>
                        <form action="/DiscussionEdit/${item.getDiscussion_ID()}">
                    ...
                    <td>
                        <form action="/DiscussionDelete/${item.getDiscussion_ID()}">
