...
<table>
    ...
    <c:forEach var="item" items="${brokerList}">
        <tr id="tableData">
            <td>${item.getBroker_Name()}</td>
            <td>${Broker_CompanyRepo.findById(item.getBroker_Company_ID()).get().getBroker_Company()}</td>
            <td>
                <form action="/BrokerEdit/${item.getBroker_ID()}">
                    <button type="submit" value="Edit">
                        <i class="fas fa-edit"></i>
                </form>
            </td>
            <td>
                <form action="/BrokerDelete/${item.getBroker_ID()}">
