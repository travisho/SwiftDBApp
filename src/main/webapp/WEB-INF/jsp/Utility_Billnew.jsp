...
<table>
    ...
    <tr class="filterBG">
        <form method="put" action="/Utility_BillNew">
            <td>
            ...
            <td><input type="text" name="Utility" value="${item.getUtility()}">

            <td><input type="text" name="Cost_Of_Utility" value="${item.getUtility_Of_Cost()}">
<%--            <td>--%>
<%--                <select name="Property_Finance">--%>
<%--                    <option value=""/>--%>
<%--                    <c:forEach var="itema" items="${Property_FinanceRepo.findAll()}">--%>
<%--                        <option value="${itema.getProperty_Finance_ID()}">--%>
<%--                                ${itema.getMonthly_Price_Estimate()}--%>
<%--                        </option>--%>
<%--                    </c:forEach>--%>
<%--                </select>--%>
<%--            </td>--%>
