...
<c:forEach var="item" items="${Home_AppraisalRepo.findAll()}">
    <c:if test="${Home_Appraisal_ID == item.getHome_Appraisal_ID()}">

        <h2>Home Appraisal Edit</h2>
        <table>
            ...
            <tr class="filterBG">
            <form method = "put" action="/Home_AppraisalEdited">
                    <td>
                        <select name="street">
                    ...
                    <td><input type="text" name="area" value="${item.getProperty_Area()}"></td>
                    <td><input type="text" name="value" value="${item.getAppraisal_Value()}"></td>
                    <td><input type="hidden" name="id" value="${item.getHome_Appraisal_ID()}"><input type="submit" value="Edit"></td>
                </form>
            </tr>
