...
<table>
    ...
    <form action="/OutdoorFilter">
        ...
        <td><input type="text" name="Patio Size Area" ></td>
        <td><input type="text" name="Sprinkler System"></td>
        <td><button class="btn"><i class="fa fa-search" style="color:white;"></i></button></td>
    </form>
    <td>
        <form action="/OutdoorRedirect">
            <button>New Outdoor</button>
        </form>
    </td>
    </tr>
    ...
    <c:forEach var="item" items="${OutdoorList}">
        <tr id="tableData">
            ...
            <td>${item.getPatio_Size_Area()}</td>
            <td>${item.getSprinkler_System()}</td>
            <td>
                <form action="/OutdoorEdit/${item.getOutdoor_ID()}">
            ...
            <td>
                <form action="/OutdoorDelete/${item.getOutdoor_ID()}">
