...
<h2>Air Conditioning Unit List</h2>
...
<table>
    ...
    <tr class="filterBG">
        <form action="/Air_Conditioning_UnitFilter">
            <td><input type="text" name="Floor_Plan" value=""></td>
            <td><input type="text" name="ACU_Type" value=""></td>
            <td><input type="text" name="ACU_Age_Years" value=""></td>
            <td><input type="submit" value="Search"></td>
        </form>

        <td>
            <form action="/Air_Conditioning_UnitRedirect">
                <button>New Air Conditioning Unit</button>
            </form>
        </td>
    </tr>
    ...
    <c:forEach var="item" items="${Air_Conditioning_UnitList}">
        <tr id="tableData">
            ...
            <td>${item.getACU_Type()}</td>
            <td>${item.getACU_Age_Years()}</td>
            <td>
                <form action="/Air_Conditioning_UnitEdit/${item.getACU_ID()}">
                    <button type="submit" value="Edit">
                        <i class="fas fa-edit"></i>
                </form>
            </td>
            <td>
                <form action="/Air_Conditioning_UnitDelete/${item.getACU_ID()}">
