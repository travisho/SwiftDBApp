...
<c:forEach var="item" items="${BathroomList}">
    <c:if test="${Bathroom_ID == item.getBathroom_ID()}">

        <h2>Bathroom ${item.getBathtub_Width()}${item.getBathtub_Length()}${item.getBathroom_Width()}${item.getBathroom_Length()}   </h2>
        ...
        <table>
            ...
            <tr>
                <th>Floor Plan</th>
                <th>Bathtub_Width</th>
                <th>Bathtub_Length</th>
                <th>Bathroom_Width</th>
                <th>Bathroom_Length</th>
                <th colspan="2">Actions</th>

            </tr>

            <tr class="filterBG">
                <form method = "put" action="/BathroomEdited">
                    <td>
                    ...
                    <td><input type="text" name="Bathtub_Width" value="${item.getBathtub_Width()}"></td>
                    <td><input type="text" name="Bathtub_Length" value="${item.getBathtub_Length()}"></td>
                    <td><input type="text" name="Bathroom_Width" value="${item.getBathroom_Width()}"></td>
                    <td><input type="text" name="Bathroom_Length" value="${item.getBathroom_Length()}"></td>
                    <td><input type="hidden" name="id" value="${item.getBathroom_ID()}">
