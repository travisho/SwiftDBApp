...
<head>
    <title>New HOA</title> <!-- CHANGE THIS TO THE TEXT THAT SHOULD APPEAR IN THE TAB BAR -->
    <meta charset="utf-8">
...
<div class="content">
    ...
    <h2>New Home Owner Associate</h2> <!-- THIS SHOULD BE TITLE OF YOUR PAGE-->
    ...
    <tr class="filterBG">
        <form method="put" action="/Homeowner_AssociateNew">
