...
<table>
    ...
    <tr class="filterBG">
        <form action="/Home_AppraisalFilter">
        ...
        <td>
            <form action="/Home_AppraisalRedirect">
    ...
    <c:forEach var="item" items="${Home_AppraisalList}">
        <tr id="tableData">
            ...
            <td>${item.getProperty_Area()}</td>
            <td>${item.getAppraisal_Value()}</td>

            <td>
                <!-- These should be getHome_Appraisal_ID() NOT getProperty_Finance_ID() -->
                <form action="/Home_AppraisalEdit/${item.getHome_Appraisal_ID()}">
            ...
            <td>
                <form action="/Home_AppraisalDelete/${item.getHome_Appraisal_ID()}">
