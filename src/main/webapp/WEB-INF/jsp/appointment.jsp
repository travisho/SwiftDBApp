        ...
        <table>
            ...
            <c:forEach var="item" items="${appointmentList}">
                <tr id="tableData">
                    ...
                    <td>${item.getAppointment_Date()}</td>
                    <td>${item.getAppointment_Time()}</td>
                    <td>${item.getAppointment_Topic()}</td>
                    <td>${item.getAppointment_Summary()}</td>

                    <td>
                        <form action="/AppointmentEdit/${item.getAppointment_ID()}">
                    ...
                    <td>
                        <form action="/AppointmentDelete/${item.getAppointment_ID()}">
