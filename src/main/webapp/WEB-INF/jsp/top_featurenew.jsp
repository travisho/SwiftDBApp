...
<div class="content">
    ...
    <h2>New Top Property feature</h2>
<table>
    ...
    <tr class="filterBG">
        <form method="put" action="/TopFeatureNew">


            <!-- Address Dropdown Start -->
            <td>
                <select name="street">
                    <option value=""/>
                    <c:forEach var="itemb" items="${propertyRepo.findAll()}">
                        <option value="${itemb.getProperty_ID()}">
                                ${itemb.getStreet_Address()}
                        </option>
                    </c:forEach>
                </select>
            </td>
            <!-- Address Dropdown End -->
