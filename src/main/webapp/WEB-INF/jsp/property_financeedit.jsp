...
<head>
    <title>Editing Property Finance</title> <!-- CHANGE THIS TO THE TEXT THAT SHOULD APPEAR IN THE TAB BAR -->
    <meta charset="utf-8">
...
<c:forEach var="item" items="${property_financeRepo.findAll()}">
    <c:if test="${Property_Finance_ID == item.getProperty_Finance_ID()}">

        <h2>Editing Property Finance Information for ${propertyRepo.findById(item.getProperty_ID()).get().getStreet_Address()}</h2>
        ...
        <tr>
            ...
            <th>Property Tax</th>
            <th>Total Price Estimate</th>
            <th>Monthly Price Estimate</th>
            <th colspan="2">Actions</th>
        </tr>

            <tr class="filterBG">
                <form method = "put" action="/Property_FinanceEdited">
                    ...
                    <td><input type="text" name="tax" value="${item.getProperty_Tax()}"></td>
                    <td><input type="text" name="totalpe" value="${item.getTotal_Price_Estimate()}"></td>
                    <td><input type="text" name="monthlype" value="${item.getMonthly_Price_Estimate()}"></td>
                    <td><input type="hidden" name="id" value="${item.getProperty_Finance_ID()}">
