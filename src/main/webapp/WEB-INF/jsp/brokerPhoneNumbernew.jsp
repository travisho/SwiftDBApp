...
<head>
    <title>New Broker Phone Number</title>
    <meta charset="utf-8">
...
<div class="content">
    ...
    <h2>Add New Broker Phone Number</h2>
<table>
    ...
    <tr class="filterBG">
        <form method="put" action="/BrokerPhoneNumberNew">
            <!-- Home Broker Dropdown Start -->
            <td>
                <select name="name">
                    <option value=""/>
                    <c:forEach var="itemb" items="${brokerRepo.findAll()}">
                        <option value="${itemb.getBroker_ID()}">
                                ${itemb.getBroker_Name()}
                        </option>
                    </c:forEach>
                </select>
            </td>
            </td>
            <!-- Home Broker Dropdown End -->
