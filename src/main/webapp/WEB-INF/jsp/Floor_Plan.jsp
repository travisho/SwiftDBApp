...
<table>
    ...
    <tr class="filterBG">
     <form action="/Floor_PlanFilter">


        <td><input type="text" name="street"></td>
        <td><input type="text" name="Floor_Plan"></td>
        <td><input type="text" name="Floor_Number"></td>
        <td><button class="btn"><i class="fa fa-search" style="color:white;"></i></button></td>

        </form>

        <td>
            <form action="/Floor_PlanRedirect">
                <button>New Floor Plan</button>
            </form>
        </td>

    </tr>

    <c:forEach var="item" items="${Floor_PlanList}">
        <tr id="tableData">
            <td>${PropertyRepo.findById(item.getProperty_ID()).get().getStreet_Address()}</td>
<%--            <td>${Floor_PlanRepo.findById(item.getFloor_Plan_ID()).get().getFloor_Plan()}</td>--%>
<%--    <td>${PropertyRepo.findById(Property_ID()).get().getStreet_Address()}</td>--%>
            <td><img src="${item.getFloor_Plan()}" alt="Floor Plan"></td>

            <td>${item.getFloor_Number()}</td>
            <td>
                <form action="/Floor_PlanEdit/${item.getFloor_Plan_ID()}">
            ...
            <td>
                <form action="/Floor_PlanDelete/${item.getFloor_Plan_ID()}">
