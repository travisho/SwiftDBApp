...
<head>
    <title>Editing Broker Phone Number</title>
    <meta charset="utf-8">
...
<div class="content">
    ...
    <body>
<c:forEach var="item" items="${broker_Phone_NumberRepo.findAll()}">
    <c:if test="${Broker_Phone_Number_ID == item.getBroker_Phone_Number_ID()}">

    <h2>Edit Broker Phone</h2>
<table>
    ...
    <tr class="filterBG">
        <form method="put" action="/BrokerPhoneNumberEdited">
            <td>
                <select name="broker">
            ...
            <td><input type="text" name="number" value="${item.getBroker_Phone_Number()}"></td>
            <td><input type="text" name="type" value="${item.getBroker_Phone_Type()}"></td>
            <td><input type="hidden" name="id" value="${item.getBroker_Phone_Number_ID()}"><input type="submit" value="Submit"></td>
        </form>
    </tr>
