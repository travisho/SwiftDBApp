...
<c:forEach var="item" items="${Title_OwnerRepo.findAll()}">
    <c:if test="${Title_OwnerID == item.getTitle_Owner_ID()}">

        <h2>Edit Title Owner</h2>
        ...
        <table>
            ...
            <tr class="filterBG">
                <form method = "put" action="/TitleOwnerEdited">

                    <td><input type="text" name="title_owner" value="${item.getTitle_Owner()}"></td>
                    <td><input type="hidden" name="id" value="${item.getTitle_Owner_ID()}"><input type="submit" value="Submit"></td>
                </form>
            </tr>
