...
<table>
    ...
    <tr class="filterBG">
        ...
        <td>
        <form action="/ClientEmailRedirect">
            <button>New Client Email</button>
        </form>
        </td>
    </tr>

    <c:forEach var="item" items="${clientEmailList}">
        <tr id="tableData">
            ...
            <td>${item.getClient_Email()}</td>
            <td>
                <form action="/ClientEmailEdit/${item.getClient_Email_ID()}">
                    <button type="submit" value="Edit">
                        <i class="fas fa-edit"></i>
                </form>
            </td>
            <td>
                <form action="/ClientEmailDelete/${item.getClient_Email_ID()}">
