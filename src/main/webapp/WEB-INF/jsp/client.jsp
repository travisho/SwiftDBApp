...
<table>
    ...
    <c:forEach var="item" items="${clientList}">
        <tr id="tableData">
            <td>${item.getClient_First_Name()}</td>
            <td>${item.getClient_Last_Name()}</td>
            <td>${Client_StatusRepo.findById(item.getClient_Status_ID()).get().getClient_Status()}</td>
            <td>${item.getClient_Type()}</td>
            <td>
                <form action="/ClientEdit/${item.getClient_ID()}">
            ...
            <td>
                <form action="/ClientDelete/${item.getClient_ID()}">
