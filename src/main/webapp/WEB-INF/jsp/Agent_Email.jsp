                ...
                <select name="agent">
                    ...
                    <c:forEach var="itema" items="${AgentRepo.findAll()}">
                        <option value="${itema.getAgent_ID()}">
                                ${itema.getAgent_First_Name()} ${itema.getAgent_Last_Name()}
                        </option>
                    </c:forEach>
                </select>
            </td>

            <td><input type="text" name="Agent_Email">
            <td><button class="btn"><i class="fa fa-search" style="color:white;"></i></button></td>

        </form>

        <td>
            <form action="/Agent_EmailRedirect">
                <button>New Agent Email</button>
            </form>
        </td>

    </tr>

    <c:forEach var="item" items="${Agent_EmailList}">
        <tr id="tableData">
            ...
            <td>${item.getAgent_Email()}</td>
            <td>
                <form action="/Agent_EmailEdit/${item.getAgent_Email_ID()}">
            ...
            <td>
                <form action="/Agent_EmailDelete/${item.getAgent_Email_ID()}">
