...
<table>
    ...
    <tr class="filterBG">
        ...
        <td>
            <form action="/ClientPhoneRedirect">
                <button>New Client Phone Number</button>
            </form>
        </td>
    </tr>

    <c:forEach var="item" items="${clientPhoneList}">
        <tr id="tableData">
            ...
            <td>${item.getClient_Phone_Number()}</td>
            <td>${item.getClient_Type()}</td>

            <td>
                <form action="/ClientPhoneEdit/${item.getClient_Phone_Number_ID()}">
                    <button type="submit" value="Edit">
                        <i class="fas fa-edit"></i>
                </form>
            </td>
            <td>
                <form action="/ClientPhoneDelete/${item.getClient_Phone_Number_ID()}">
